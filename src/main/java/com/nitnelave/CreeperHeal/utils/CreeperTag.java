...
public class CreeperTag implements Tag<Material> {
    ...
    public static final CreeperTag FLOWERS =
            new CreeperTag(Material.DANDELION, Material.POPPY, Material.BLUE_ORCHID, Material.ALLIUM,
    ...
    public static final CreeperTag INFESTED_BLOCKS =
            new CreeperTag(Material.INFESTED_CHISELED_STONE_BRICKS, Material.INFESTED_COBBLESTONE,
    ...
    public static final CreeperTag STANDING_BANNERS =
            new CreeperTag(Material.BLACK_BANNER, Material.BLUE_BANNER, Material.BROWN_BANNER, Material.CYAN_BANNER,
    ...
    public static final CreeperTag WALL_BANNERS =
            new CreeperTag(Material.BLACK_WALL_BANNER, Material.BLUE_WALL_BANNER, Material.BROWN_WALL_BANNER, Material.CYAN_WALL_BANNER,
    ...
    public static final CreeperTag DOUBLE_FLOWERS =
            new CreeperTag(Material.SUNFLOWER, Material.LILAC, Material.ROSE_BUSH, Material.PEONY);

    private final Set<Material> tagged;

    private CreeperTag(Material... elements) {
